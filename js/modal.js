...
const drinksData = {
  ...
  // ===== ЧАЙ =====
  "клубничный чай": { description: "Нежный клубничный аромат с лёгкой сладостью и мягким послевкусием.", prices: ["210 ₽"] },
  ...
  "зелёный чай": { description: "Классический зелёный чай с чистым вкусом и тонким травяным профилем.", prices: ["200 ₽"] },
  "персиковый чай": { description: "Деликатный персиковый оттенок в мягкой чайной основе.", prices: ["220 ₽"] },
  "фирменный чай": { description: "Авторская смесь с глубоким ароматом и выразительным характером.", prices: ["250 ₽"] },
  "цитрусовый чай": { description: "Освежающий цитрусовый купаж с бодрящим послевкусием.", prices: ["230 ₽"] },
  "Чёрный чай": { description: "Насыщенный чёрный чай с плотной структурой и благородной терпкостью.", prices: ["200 ₽"] },
  "жасминовый чай": { description: "Тонкий цветочный аромат жасмина в изящной чайной композиции.", prices: ["210 ₽"] },
  "Английская Королева": { description: "Элегантный классический купаж с глубоким, бархатным вкусом.", prices: ["200 ₽"] },
  "ягодный чай": { description: "Ягодный букет с мягкой кислинкой и насыщенным ароматом.", prices: ["250 ₽"] },
  "облепиховый чай": { description: "Облепиха с яркой природной кислинкой и согревающим эффектом.", prices: ["250 ₽"] },
  "горный чай": { description: "Чистый травяной профиль с освежающей горной свежестью.", prices: ["210 ₽"] },
  "таёжный чай": { description: "Глубокий травяной купаж с природной хвойной нотой.", prices: ["210 ₽"] },
  "глинтвейн": { description: "Пряный аромат специй и фруктов в согревающей интерпретации.", prices: ["250 ₽"] },
  "манго чай": { description: "Тропическая сладость манго с яркой маракуйей в чайной основе.", prices: ["210 ₽"] },
